package com.example.novitaguok.android_opencv.custom;
...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public interface CvCameraViewListener2 {
         ...
         * TODO: pass the parameters specifying the format of the frame (BPP, YUV or RGB and etc)
         */
        public Mat onCameraFrame(org.opencv.android.CameraBridgeViewBase.CvCameraViewFrame inputFrame);
    }

    @SuppressWarnings("WeakerAccess")
    protected class CvCameraViewListenerAdapter implements org.opencv.android.CameraBridgeViewBase.CvCameraViewListener2 {
        public CvCameraViewListenerAdapter(org.opencv.android.CameraBridgeViewBase.CvCameraViewListener oldStypeListener) {
     ...
     */
    public void setCvCameraViewListener(org.opencv.android.CameraBridgeViewBase.CvCameraViewListener2 listener) {
        mListener = listener;
    }

    public void setCvCameraViewListener(org.opencv.android.CameraBridgeViewBase.CvCameraViewListener listener) {
        org.opencv.android.CameraBridgeViewBase.CvCameraViewListenerAdapter adapter = new org.opencv.android.CameraBridgeViewBase.CvCameraViewListenerAdapter(listener);
    ...
    {
        mPreviewFormat = format;
        if (mListener instanceof org.opencv.android.CameraBridgeViewBase.CvCameraViewListenerAdapter) {
            org.opencv.android.CameraBridgeViewBase.CvCameraViewListenerAdapter adapter = (org.opencv.android.CameraBridgeViewBase.CvCameraViewListenerAdapter) mListener;
            adapter.setFrameFormat(mPreviewFormat);
        }
    }
     ...
     */
    protected void deliverAndDrawFrame(org.opencv.android.CameraBridgeViewBase.CvCameraViewFrame frame) {
        Mat modified;
     ...
     */
    protected Size calculateCameraFrameSize(List<?> supportedSizes, org.opencv.android.CameraBridgeViewBase.ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        int calcWidth = 0;
        int calcHeight = 0;
